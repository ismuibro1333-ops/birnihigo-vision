...
import { Leaf, Recycle, Sprout, ArrowRight, Shield, TrendingUp, Globe, Droplets, Zap, Users, Package } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            { label: "Market Reach", value: "135M+", icon: Globe, detail: "Total Population served" },
          ].map((stat, i) => (
